...
class MessagesViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        chatsListData.append(messagesListStruct(name: "Никита Казанцев", id: "USAxWDpxyWy2KQBqrs6gqqJ7mc2E84wz", lastMessage: "Мы тут у BMW двигатель на МКАДе взорвали. Подьезжай!", timeOfLastMessage: Date(), isOnline: true, numberOfUnread: 2, isMuted: false))
        chatsListData.append(messagesListStruct(name: "Никита Казанцев", id: "buFKx4meCBN3LtGmACJs55vCFca8Guhc", lastMessage: "Пора заканчивать разработку бизнес логики и начинать в том самом бла бла", timeOfLastMessage: Date().addingTimeInterval(-15000), isOnline: false, numberOfUnread: 105, isMuted: true))
        chatsListData.append(messagesListStruct(name: "Никита Казанцев", id: "USAxWDpxyWy2KQBqrs6gqqJ7mc2E84wz", lastMessage: "Hi dude! Where are you? I’ll be there soon", timeOfLastMessage: Date().addingTimeInterval(-86400), isOnline: true, numberOfUnread: 2, isMuted: false))
