...
class PeopleViewController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    func addSegmentControll () {
        ...
        segmantControl.segments = addSegmentButtons(names: ["Activity", "People"])
